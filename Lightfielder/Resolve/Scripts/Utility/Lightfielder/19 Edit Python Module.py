"""
Lightfielder 19 Edit Python Module.py 2026-09-02 07.10 PM (UTC -3)
By Andrew Hazelden <andrew@andrewhazelden.com>

Edit the Lightfielder Python module using the script editor defined in Fusion's preferences.
...
if __name__ == "__main__":
	...
	# This feature requires the "xdg-open" package to be installed on Linux.
	ExternalEditor("Scripts:/Support/lightfielder.py")
