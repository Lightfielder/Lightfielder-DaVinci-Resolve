...
In the 3D graphics and immersive media sector, Lightfielder is an LGPL licensed open-source hybrid computer-vision IDE and digital content creation (DCC) toolset developed by Andrew Hazelden. It is designed to unify volumetric video content creation and XR post-production.
